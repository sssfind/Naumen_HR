...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(PeerSkillStarAlreadyGivenException.class)
    public ResponseEntity<ErrorResponse> handlePeerStarAlreadyGiven(PeerSkillStarAlreadyGivenException ex,
                                                                    HttpServletRequest request) {
        return buildResponse(HttpStatus.CONFLICT, "Conflict", ex.getMessage(), request);
    }
    ...
    public ResponseEntity<ErrorResponse> handleSelfInvitationNotAllowed(SelfInvitationNotAllowedException ex,
                                                                        HttpServletRequest request) {
        return buildResponse(HttpStatus.BAD_REQUEST, "Bad Request", ex.getMessage(), request);
    }

    @ExceptionHandler(UserNotInvitedToEventException.class)
    public ResponseEntity<ErrorResponse> handleUserNotInvitedToEvent(UserNotInvitedToEventException ex,
                                                                     HttpServletRequest request) {
        return buildResponse(HttpStatus.BAD_REQUEST, "Bad Request", ex.getMessage(), request);
    }
    ...
    public ResponseEntity<ErrorResponse> handleTypeMismatch(MethodArgumentTypeMismatchException ex,
        ...
        String message = String.format(
                "Недопустимое значение '%s' для параметра '%s'",
